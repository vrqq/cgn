...
clang++ -x c++-header -std=c++11 -fPIC ./proof/fastbuild/cgn_pch.h -I. -Icgn-out/cell_include -DDUMMYDEFINE -DCGN_VAR_PREFIX=hello_2FBUILD_2Ecgn_2Ecc -DCGN_ULABEL_PREFIX=\"//hello:\"
