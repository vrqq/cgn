#include<vector>
#include<string>
static std::string protobuf_SOURCE_DIR = "";
...
std::vector<std::string> libprotoc_public_srcs = {
...
std::vector<std::string> libprotoc_public_hdrs = {
...
std::vector<std::string> go_features_proto_proto_srcs = {
    protobuf_SOURCE_DIR + "/go/google/protobuf/go_features.proto",
};

std::vector<std::string> go_features_proto_srcs = {
    protobuf_SOURCE_DIR + "/go/go_features.proto.pb.cc",
};

std::vector<std::string> go_features_proto_hdrs = {
    protobuf_SOURCE_DIR + "/go/go_features.proto.pb.h",
};

std::vector<std::string> go_features_proto_files = {
...
std::vector<std::string> upb_test_util_srcs = {
...
std::vector<std::string> upb_test_util_hdrs = {
...
std::vector<std::string> conformance_testee_srcs = {
    protobuf_SOURCE_DIR + "/conformance/conformance_cpp.cc",
};

std::vector<std::string> conformance_testee_hdrs = {
    "",
};

std::vector<std::string> conformance_runner_srcs = {
...
std::vector<std::string> conformance_runner_hdrs = {
...
std::vector<std::string> lazily_build_dependencies_test_files = {
