...
struct CMakeContext {
    ...
    cgn::TargetInfos add_dep(const std::string label);
    cgn::TargetInfos add_dep(const std::string label, cgn::Configuration cfg);

private: friend class CMakeInterpreter;
...
struct CMakeInterpreter {
    ...
    // constexpr static const char *script_labels[] = {
    //     "@cgn.d//library/cxx.cgn.bundle",
    //     "@cgn.d//library/cmake.cgn.cc"
    // };

    // constexpr static const char *script_label = "@cgn.d//library/cmake.cgn.cc";
