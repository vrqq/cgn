// Auto-generated from repo/gen/sources.gni

#include <string>
#include <vector>
using namespace std;

std::vector<std::string> bcm_sources = {
  "crypto/fipsmodule/bcm.cc",
};

std::vector<std::string> bcm_internal_headers = {
...
std::vector<std::string> bcm_sources_asm = {
...
std::vector<std::string> bcm_sources_nasm = {
...
std::vector<std::string> bssl_sources = {
  "tool/args.cc",
  "tool/ciphers.cc",
  "tool/client.cc",
  "tool/const.cc",
...
std::vector<std::string> bssl_internal_headers = {
  "tool/internal.h",
  "tool/transport_common.h",
};

std::vector<std::string> crypto_sources = {
...
std::vector<std::string> crypto_headers = {
...
std::vector<std::string> crypto_internal_headers = {
...
std::vector<std::string> crypto_sources_asm = {
...
std::vector<std::string> crypto_sources_nasm = {
...
std::vector<std::string> crypto_test_sources = {
...
std::vector<std::string> crypto_test_data = {
...
std::vector<std::string> decrepit_sources = {
...
std::vector<std::string> decrepit_internal_headers = {
  "decrepit/cast/internal.h",
  "decrepit/macros.h",
};

std::vector<std::string> decrepit_test_sources = {
  "crypto/test/gtest_main.cc",
...
std::vector<std::string> fuzz_sources = {
  "fuzz/arm_cpuinfo.cc",
  "fuzz/bn_div.cc",
  "fuzz/bn_mod_exp.cc",
  "fuzz/cert.cc",
...
std::vector<std::string> pki_sources = {
...
std::vector<std::string> pki_headers = {
...
std::vector<std::string> pki_internal_headers = {
  "pki/cert_error_id.h",
...
std::vector<std::string> pki_test_sources = {
  "crypto/test/gtest_main.cc",
...
std::vector<std::string> pki_test_data = {
...
std::vector<std::string> rust_bssl_crypto_sources = {
...
std::vector<std::string> rust_bssl_sys_sources = {
  "rust/bssl-sys/src/lib.rs",
};

std::vector<std::string> ssl_sources = {
  "ssl/bio_ssl.cc",
  "ssl/d1_both.cc",
  "ssl/d1_lib.cc",
  "ssl/d1_pkt.cc",
...
std::vector<std::string> ssl_headers = {
...
std::vector<std::string> ssl_internal_headers = {
  "ssl/internal.h",
};

std::vector<std::string> ssl_test_sources = {
  "crypto/test/gtest_main.cc",
  "ssl/span_test.cc",
  "ssl/ssl_c_test.c",
...
std::vector<std::string> test_support_sources = {
...
std::vector<std::string> test_support_internal_headers = {
...
std::vector<std::string> test_support_sources_asm = {
...
std::vector<std::string> test_support_sources_nasm = {
  "gen/test_support/trampoline-x86-win.asm",
  "gen/test_support/trampoline-x86_64-win.asm",
};

std::vector<std::string> urandom_test_sources = {
