...
#define CGN_RULE_TITLE1(x, y, z) x##y##_##z
...
#define CGN_FAST_PROCESSOR(FnProcessor, TContext, Name, CtxD) \
    void CGN_RULE_TITLE(_tf, CGN_VAR_PREFIX, __LINE__)(TContext &CtxD); \
    std::vector<std::shared_ptr<void>> CGN_RULE_TITLE(_tfreg, CGN_VAR_PREFIX, __LINE__) \
        = FnProcessor(CGN_ULABEL_PREFIX, Name, &CGN_RULE_TITLE(_tf, CGN_VAR_PREFIX, __LINE__)); \
    void CGN_RULE_TITLE(_tf, CGN_VAR_PREFIX, __LINE__)(TContext &CtxD)
