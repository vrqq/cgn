...
# https://chromium.googlesource.com/chromium/deps/nasm.git/+/refs/heads/main/generate_nasm_sources.py
#
...
def PrintFileList(out, name, files):
    if len(files) == 0:
        ...
        print("};\n", file=out)
def main():
    file_lists = ParseFileLists("repo/Makefile.in")
    with open("nasm_sources.cgn.h", "w") as out:
        print(
